...
public class EmployeeController {
	...
	@ApiOperation(value = "Get Employee", notes = "Get employee by project id")
	@GetMapping(value = "/employees", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<Employee>> getEmployee(@RequestParam("projectId") Integer id) {

		List<Employee> persistedEmp = empService.findAllByProjects_IdIn(id);
